                        ...
                        <div className="card-block" id="unblockpwd">
                            ...
                            <div className="row">
                                <div className="space col-md-4 col-md-offset-2 col-xl-3 col-xl-offset-3">
                                    <Link to="/unblock" className="btn btn-danger btn-block" activeClassName="active">Cancelar</Link>
                                </div>
                                <div className="space col-md-4 col-xl-3">
                                    <Link to="/" className="btn btn-info btn-block" activeClassName="active">Continuar</Link>
                                </div>
                            </div>
                        </div>
